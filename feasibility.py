...
def calculate_and_get_geojson(gdf, criteria, logic="AND"):
    """
    ...
    # Get distribution and stats
    distribution = get_feasibility_distribution(gdf_with_feas)
    stats = get_feasibility_stats(gdf_with_feas)
