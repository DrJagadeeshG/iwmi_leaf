...
INTERVENTIONS = {
    "Organic Farming": {
        ...
        "description": "Organic farming focuses on sustainable agricultural practices without synthetic chemicals, emphasizing soil health and biodiversity.",
    },
    "Integrated Farming": {
        "key": "Integrated Farming",
        "name": "Integrated Farming",
        "description": "Integrated farming combines crop and livestock production with efficient resource use and diversified income streams.",
    },
    "Natural Farming": {
        "key": "Natural Farming",
        "name": "Natural Farming",
        "description": "Natural farming emphasizes minimal external inputs, using indigenous microorganisms and natural processes for soil fertility.",
    },
}
